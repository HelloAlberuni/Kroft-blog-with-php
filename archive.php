	        	...
	        	<div id="page-wrap">
					...
					<div id="side-content">
						...
						<?php
							...
							$statement = $db->prepare("SELECT * FROM tbl_post WHERE post_month=$month AND post_year=$year ORDER BY post_id DESC");
							$statement->execute();
							...
							$statement = $db->prepare("SELECT * FROM tbl_post WHERE post_month=$month AND post_year=$year ORDER BY post_id DESC LIMIT $start, $limit");
							$statement->execute();
							...
							{   
								...
								if ($page > 1) 
									$pagination.= "<li><a href=\"$targetpage?date=$date&page=$prev\">&lsaquo;</a></li>";
								else
								...
								{   
									for ($counter = 1; $counter <= $lastpage; $counter++)
									{
										if ($counter == $page)
											...
											$pagination.= "<li><a href=\"$targetpage?date=$date&page=$counter\">$counter</a></li>";                 
									}
								}
								elseif($lastpage > 5 + ($adjacents * 2))    //enough pages to hide some
								{
									if($page < 1 + ($adjacents * 2))        
									{
										...
										$pagination.= "...";
										$pagination.= "<li><a href=\"$targetpage?date=$date&page=$lpm1\">$lpm1</a></li>";
										$pagination.= "<li><a href=\"$targetpage?date=$date&page=$lastpage\">$lastpage</a></li>";       
									}
									elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
									{
										$pagination.= "<li><a href=\"$targetpage?date=$date&page=1\">1</a></li>";
										$pagination.= "<li><a href=\"$targetpage?date=$date&page=2\">2</a></li>";
										$pagination.= "...";
								...
								if ($page < $counter - 1) 
									$pagination.= "<li><a href=\"$targetpage?date=$date&page=$next\">&rsaquo;</a></li>";
								else
