					...
					<div id="side-content">
						...
						<?php
							...
							{   
								...
								if ($page > 1) 
									$pagination.= "<li><a href=\"$targetpage?page=$prev\">&lsaquo;</a></li>";
								else
								...
								if ($page < $counter - 1) 
									$pagination.= "<li><a href=\"$targetpage?page=$next\">&rsaquo;</a></li>";
								else
						...
						?>
							...
							<?php
								...
								foreach($result as $row) {
									?>
									<div class="post">
										<a href="single.php?id=<?php echo $row['post_id']; ?>" class="post-feature-img">
